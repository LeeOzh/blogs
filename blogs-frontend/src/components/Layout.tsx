...
const  MeunItem = ({text}:{text: string}) => {
  return <span className=' transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:text-gray-500 hover:cursor-pointer'>{text}</span>
};
